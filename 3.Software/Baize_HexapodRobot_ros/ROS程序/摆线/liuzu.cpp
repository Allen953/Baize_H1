...
0,0,0,0,0,0
    ...
    { 
        ...
        rb_end_effector_pose1.p.data[0]=rb_end_effector_pose.p.data[0]-Am*pi+x;
        ...
        rm_end_effector_pose1.p.data[0]=rm_end_effector_pose.p.data[0]-Am*pi+Am*2*pi-x;
        ...
        rf_end_effector_pose1.p.data[0]=rf_end_effector_pose.p.data[0]-Am*pi+x;
        ...
        lf_end_effector_pose1.p.data[0]=lf_end_effector_pose.p.data[0]-Am*pi+Am*2*pi-x;
        ...
        lm_end_effector_pose1.p.data[0]=lm_end_effector_pose.p.data[0]-Am*pi+x;
        ...
        lb_end_effector_pose1.p.data[0]=lb_end_effector_pose.p.data[0]-Am*pi+Am*2*pi-x;
    ...
    { 
        ...
        double x=Am*(t-sin(t));
        double z=Am*(1-cos(t));
        rb_end_effector_pose1.p.data[0]=rb_end_effector_pose.p.data[0]-Am*pi+Am*2*pi-x;
        rb_end_effector_pose1.p.data[2]=rb_end_effector_pose.p.data[2]-0.04;
        int rc_rb = tracik_rb_solver.CartToJnt(resu_last_rb, rb_end_effector_pose1, result_rb);

        rm_end_effector_pose1.p.data[0]=rm_end_effector_pose.p.data[0]-Am*pi+x;
        rm_end_effector_pose1.p.data[2]=rm_end_effector_pose.p.data[2]+z-0.04;
        int rc_rm = tracik_rm_solver.CartToJnt(resu_last_rm, rm_end_effector_pose1, result_rm);

        rf_end_effector_pose1.p.data[0]=rf_end_effector_pose.p.data[0]-Am*pi+Am*2*pi-x;
        rf_end_effector_pose1.p.data[2]=rf_end_effector_pose.p.data[2]-0.04;
        int rc_rf = tracik_rf_solver.CartToJnt(resu_last_rf, rf_end_effector_pose1, result_rf);

        lf_end_effector_pose1.p.data[0]=lf_end_effector_pose.p.data[0]-Am*pi+x;
        lf_end_effector_pose1.p.data[2]=lf_end_effector_pose.p.data[2]+z-0.04;
        int rc_lf = tracik_lf_solver.CartToJnt(resu_last_lf, lf_end_effector_pose1, result_lf);

        lm_end_effector_pose1.p.data[0]=lm_end_effector_pose.p.data[0]-Am*pi+Am*2*pi-x;
        lm_end_effector_pose1.p.data[2]=lm_end_effector_pose.p.data[2]-0.04;
        int rc_lm = tracik_lm_solver.CartToJnt(resu_last_lm, lm_end_effector_pose1, result_lm);

        lb_end_effector_pose1.p.data[0]=lb_end_effector_pose.p.data[0]-Am*pi+x;
